...
extern void *ExtMPlyJmpTbl[];

typedef void (*XcmdFunc)(struct MusicPlayerInfo *, struct MusicPlayerTrack *);
extern const XcmdFunc xcmd_tbl[];

extern struct CgbChannel m4a_cgbchn[];

extern const u8 ScaleTable[];
extern const u32 FreqTable[];
extern const u16 pcmVBtbl_rev[];

extern const u8 CgbScTable[];
extern const s16 CgbFrTable[];
extern const u8 NoiseTable[];

extern const struct PokemonCrySong gPokemonCrySongTemplate;

extern const struct ToneData voicegroup_pokemon_cry;

extern char __total_mplay_n[];
extern char __max_line[];

#define NUM_MUSIC_PLAYERS ((u16)__total_mplay_n)
#define MAX_LINE ((u8)__max_line)
...
void ply_note_rev01(struct MusicPlayerInfo *, struct MusicPlayerTrack *);
