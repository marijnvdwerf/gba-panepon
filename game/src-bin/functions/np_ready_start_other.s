...
.Lnp_ready_start_other_38:
	cmp	r0, #0
	bne	.Lnp_ready_start_other_54	@cond_branch
	mov	r0, #0x6
	strb	r0, [r1, #0x9]
	b	.Lnp_ready_start_other_54
...
.Lnp_ready_start_other_12:
	bl	np_rdyst_cslmov
	bl	np_rdyst_ready
	ldr	r1, .Lnp_ready_start_other_52 @ NRam
	ldrb	r0, [r1, #0x13]
	cmp	r0, #0
	bne	.Lnp_ready_start_other_54	@cond_branch
	mov	r0, #0x1
...
.Lnp_ready_start_other_15:
	...
	strb	r1, [r5, #0x8]
	strb	r0, [r5, #0x4]
	ldr	r2, .Lnp_ready_start_other_52 + 4 @ 0xa9c
	add	r0, r5, r2
	strb	r1, [r0]
	mov	r0, #0x3c
	strb	r0, [r5, #0xf]
...
.Lnp_ready_start_other_16:
	ldrb	r0, [r5, #0xf]
	cmp	r0, #0
	ble	.Lnp_ready_start_other_50	@cond_branch
	sub	r0, r0, #0x1
	b	.Lnp_ready_start_other_51
...
.Lnp_ready_start_other_51:
	...
	ldr	r0, .Lnp_ready_start_other_55 @ 0xa88
	add	r1, r5, r0
	mov	r0, #0x1
	strb	r0, [r1]
	strb	r4, [r5, #0x9]
