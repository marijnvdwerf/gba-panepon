...
nis_game_main:
	...
	ldr	r1, .Lnis_game_main_5 + 4 @ 0xa61
	add	r3, r0, r1
	ldrb	r2, [r3]
	add	r4, r0, #0
	cmp	r2, #0
	...
	mov	r0, #0x1
	strb	r0, [r3]
	ldr	r1, .Lnis_game_main_5 + 12 @ 0xa66
	add	r0, r4, r1
	strb	r2, [r0]
.Lnis_game_main_2:
	add	r7, r4, #0
	ldr	r1, .Lnis_game_main_5 + 16 @ 0xa5c
	add	r0, r7, r1
	ldrb	r0, [r0]
	cmp	r0, #0
...
.Lnis_game_main_5:
	...
	.word	0xa5c
.Lnis_game_main_3:
	ldr	r0, .Lnis_game_main_13 @ 0xa61
	add	r5, r7, r0
	ldrb	r0, [r5]
	cmp	r0, #0
	...
	ldrb	r6, [r5]
	cmp	r6, #0
	bne	.Lnis_game_main_26	@cond_branch
	...
	cmp	r0, #0
	beq	.Lnis_game_main_26	@cond_branch
	b	.Lnis_game_main_12
.Lnis_game_main_14:
	.align	2, 0
.Lnis_game_main_13:
...
.Lnis_game_main_10:
	...
	strb	r4, [r5]
	ldr	r1, .Lnis_game_main_17 + 4 @ 0xa66
	add	r0, r7, r1
	strb	r6, [r0]
	b	.Lnis_game_main_26
.Lnis_game_main_18:
...
.Lnis_game_main_7:
	ldrb	r0, [r4, #0x9]
	cmp	r0, #0
	beq	.Lnis_game_main_25	@cond_branch
	bl	np_ready_start
	ldr	r0, .Lnis_game_main_27 @ ARam
	ldrb	r0, [r0, #0x2]
	cmp	r0, #0x9
	bne	.Lnis_game_main_25	@cond_branch
	ldr	r1, .Lnis_game_main_27 + 4 @ 0xa9c
	add	r0, r4, r1
	ldrb	r0, [r0]
	cmp	r0, #0
	bne	.Lnis_game_main_25	@cond_branch
