...
npgoWLD_bigchr_main:
	...
	ldr	r2, .LnpgoWLD_bigchr_main_3 + 16 @ 0xbcc
	add	r0, r4, r2
	ldrb	r0, [r0]
	strh	r0, [r1]
	ldr	r1, .LnpgoWLD_bigchr_main_3 + 20 @ b_BG2HOFS
	ldr	r3, .LnpgoWLD_bigchr_main_3 + 24 @ 0xfffe
	add	r0, r3, #0
	strh	r0, [r1]
	bl	np_chk_start_key_s
	cmp	r0, #0
	bne	.LnpgoWLD_bigchr_main_1	@cond_branch
	ldr	r1, .LnpgoWLD_bigchr_main_3 + 28 @ 0xbac
	add	r0, r4, r1
	ldr	r0, [r0]
	cmp	r0, #0
...
.LnpgoWLD_bigchr_main_1:
	...
	ldr	r2, .LnpgoWLD_bigchr_main_3 + 32 @ 0xbc8
	add	r1, r1, r2
	ldrb	r0, [r1]
	add	r0, r0, #0x1
	strb	r0, [r1]
