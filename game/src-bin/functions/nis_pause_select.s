...
nis_pause_select:
	...
	ldr	r1, .Lnis_pause_select_3 + 4 @ 0xa64
	add	r0, r2, r1
	ldrb	r0, [r0]
	sub	r4, r0, #1
...
.Lnis_pause_select_1:
	...
	orr	r0, r0, r1
	strh	r0, [r2]
	ldr	r1, .Lnis_pause_select_8 @ 0xa63
	add	r0, r3, r1
	ldrb	r0, [r0]
	cmp	r0, #0
...
.Lnis_pause_select_6:
	...
	ldr	r2, .Lnis_pause_select_16 + 8 @ 0xa63
	add	r0, r0, r2
	ldrb	r3, [r0]
	sub	r3, r3, #0x1
	cmp	r3, #0
...
.Lnis_pause_select_12:
	...
	ldr	r5, .Lnis_pause_select_16 + 8 @ 0xa63
	add	r0, r1, r5
	strb	r3, [r0]
	add	r3, r1, #0
.Lnis_pause_select_10:
	ldr	r1, .Lnis_pause_select_16 + 8 @ 0xa63
	add	r0, r3, r1
	ldrb	r0, [r0]
	cmp	r0, r4
...
.Lnis_pause_select_14:
	...
	ldr	r2, .Lnis_pause_select_27 + 8 @ 0xa63
	add	r0, r0, r2
	ldrb	r1, [r0]
	add	r1, r1, #0x1
	cmp	r1, #0
...
.Lnis_pause_select_20:
	ldr	r0, .Lnis_pause_select_27 + 4 @ NRam
	ldr	r3, .Lnis_pause_select_27 + 8 @ 0xa63
	add	r0, r0, r3
	strb	r1, [r0]
...
.Lnis_pause_select_18:
	...
	add	r1, r1, #0x2c
	strb	r0, [r1]
	ldr	r0, .Lnis_pause_select_27 + 16 @ 0xa66
	add	r2, r2, r0
	ldrb	r0, [r2]
	add	r0, r0, #0x1
	strb	r0, [r2]
.Lnis_pause_select_21:
	...
	ldr	r2, .Lnis_pause_select_27 + 16 @ 0xa66
	add	r1, r1, r2
	ldrb	r0, [r1]
	add	r0, r0, #0x1
	strb	r0, [r1]
