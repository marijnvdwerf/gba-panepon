...
np_game_code_sort:
	...
	ldr	r2, .Lnp_game_code_sort_2 + 4 @ 0x848
	add	r1, r0, r2
...
.Lnp_game_code_sort_4:
	...
	ldr	r1, .Lnp_game_code_sort_11 + 4 @ 0x84a
	add	r2, r0, r1
...
.Lnp_game_code_sort_8:
	...
	mov	ip, r0
	ldr	r1, .Lnp_game_code_sort_19 + 4 @ 0x84a
	mov	r9, r1
.Lnp_game_code_sort_18:
	...
	lsl	r0, r7, #0x2
	ldr	r2, .Lnp_game_code_sort_19 + 4 @ 0x84a
	add	r0, r0, r2
...
.Lnp_game_code_sort_14:
	...
	strh	r0, [r4]
	strh	r5, [r2]
	ldr	r2, .Lnp_game_code_sort_19 + 8 @ 0x848
	add	r3, r3, r2
	ldrh	r2, [r3]
	ldr	r0, .Lnp_game_code_sort_19 + 8 @ 0x848
	add	r1, r1, r0
	ldrh	r0, [r1]
	strh	r0, [r3]
	strh	r2, [r1]
