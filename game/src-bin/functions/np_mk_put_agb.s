...
.Lnp_mk_put_agb_1:
	...
	ldr	r1, .Lnp_mk_put_agb_5 + 4 @ 0xbbd
	add	r0, r4, r1
	ldrb	r5, [r0]
	ldr	r2, .Lnp_mk_put_agb_5 + 8 @ 0xbbc
	add	r4, r4, r2
	ldrb	r1, [r4]
	mov	r2, #0x80
	lsl	r2, r2, #0x7
...
.Lnp_mk_put_agb_3:
	...
	ldr	r0, .Lnp_mk_put_agb_11 + 16 @ 0xbbc
	add	r1, r2, r0
	ldrb	r0, [r1]
	add	r0, r0, #0xe
	strb	r0, [r1]
	...
	add	r7, r4, #0
	add	r6, r1, #0
	ldr	r1, .Lnp_mk_put_agb_11 + 20 @ 0xbbd
	add	r1, r1, r2
	mov	sl, r1
.Lnp_mk_put_agb_14:
	sub	r0, r5, #1
...
.Lnp_mk_put_agb_8:
	...
	orr	r0, r0, r1
	ldrb	r3, [r6]
	ldr	r2, .Lnp_mk_put_agb_11 + 24 @ np_mk_put_agb_Rens_Lketa
	lsl	r1, r5, #0x1
	add	r1, r1, r7
	ldrh	r1, [r1]
	lsl	r1, r1, #0x1
...
.Lnp_mk_put_agb_13:
	...
	ldr	r2, .Lnp_mk_put_agb_19 + 12 @ 0xbbc
	add	r0, r0, r2
	mov	r1, sp
	ldrb	r1, [r1, #0x8]
	strb	r1, [r0]
...
.Lnp_mk_put_agb_15:
	...
	ldr	r1, .Lnp_mk_put_agb_19 + 16 @ 0xbbd
	add	r0, r4, r1
	ldrb	r5, [r0]
	ldr	r2, .Lnp_mk_put_agb_19 + 12 @ 0xbbc
	add	r4, r4, r2
	...
	add	r0, r2, #0
	orr	r1, r1, r0
	ldr	r2, .Lnp_mk_put_agb_19 + 20 @ np_mk_put_agb_Douj_1keta
	lsl	r0, r3, #0x1
	add	r0, r0, r2
	ldrh	r0, [r0]
	mov	r2, r8
...
.Lnp_mk_put_agb_17:
	...
	ldr	r0, .Lnp_mk_put_agb_25 + 16 @ 0xbbc
	add	r1, r2, r0
	ldrb	r0, [r1]
	add	r0, r0, #0xe
	strb	r0, [r1]
	...
	add	r7, r4, #0
	add	r6, r1, #0
	ldr	r1, .Lnp_mk_put_agb_25 + 20 @ 0xbbd
	add	r1, r1, r2
	mov	sl, r1
.Lnp_mk_put_agb_28:
	sub	r0, r5, #1
...
.Lnp_mk_put_agb_22:
	...
	orr	r0, r0, r1
	ldrb	r3, [r6]
	ldr	r2, .Lnp_mk_put_agb_25 + 24 @ np_mk_put_agb_Douj_Lketa
	lsl	r1, r5, #0x1
	add	r1, r1, r7
	ldrh	r1, [r1]
	lsl	r1, r1, #0x1
...
.Lnp_mk_put_agb_27:
	...
	ldr	r2, .Lnp_mk_put_agb_29 + 12 @ 0xbbc
	add	r0, r0, r2
	mov	r1, sp
	ldrb	r1, [r1, #0x8]
	strb	r1, [r0]
