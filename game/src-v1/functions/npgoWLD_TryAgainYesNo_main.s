...
npgoWLD_TryAgainYesNo_main:
	...
	ldr	r2, .LnpgoWLD_TryAgainYesNo_main_5 + 8 @ 0xbcc
	add	r0, r0, r2
	ldrb	r0, [r0]
	strh	r0, [r1]
	ldr	r1, .LnpgoWLD_TryAgainYesNo_main_5 + 12 @ b_BG2HOFS
	ldr	r2, .LnpgoWLD_TryAgainYesNo_main_5 + 16 @ 0xfffe
	add	r0, r2, #0
	strh	r0, [r1]
	ldr	r0, .LnpgoWLD_TryAgainYesNo_main_5 + 20 @ KeyRead_Trg
	ldrh	r1, [r0]
	mov	r0, #0x34
	and	r0, r0, r1
	cmp	r0, #0
	beq	.LnpgoWLD_TryAgainYesNo_main_1	@cond_branch
	ldr	r0, .LnpgoWLD_TryAgainYesNo_main_5 + 24 @ ARam
	add	r1, r0, #0
	add	r1, r1, #0x2b
	ldrb	r1, [r1]
	add	r1, r1, #0x1
...
.LnpgoWLD_TryAgainYesNo_main_1:
	...
	ldr	r0, .LnpgoWLD_TryAgainYesNo_main_5 + 28 @ 0xbc8
	add	r1, r1, r0
	ldrb	r0, [r1]
	add	r0, r0, #0x1
	strb	r0, [r1]
