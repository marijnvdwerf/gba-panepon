...
npgoWLD_TryAgainYesNo_Af_main:
	...
	ldr	r2, .LnpgoWLD_TryAgainYesNo_Af_main_6 + 8 @ 0xbcc
	add	r0, r4, r2
	ldrb	r0, [r0]
	strh	r0, [r1]
	ldr	r1, .LnpgoWLD_TryAgainYesNo_Af_main_6 + 12 @ b_BG2HOFS
	ldr	r2, .LnpgoWLD_TryAgainYesNo_Af_main_6 + 16 @ 0xfffe
	add	r0, r2, #0
	strh	r0, [r1]
	bl	np_chk_start_key_s
	add	r1, r0, #0
	ldr	r0, .LnpgoWLD_TryAgainYesNo_Af_main_6 + 20 @ 0xbca
	add	r4, r4, r0
	ldrh	r0, [r4]
	add	r0, r0, #0x1
	strh	r0, [r4]
...
.LnpgoWLD_TryAgainYesNo_Af_main_1:
	mov	r0, #0x0
	strh	r0, [r4]
	ldr	r0, .LnpgoWLD_TryAgainYesNo_Af_main_6 + 24 @ ARam
	ldrb	r1, [r0, #0x2]
	add	r3, r0, #0
	cmp	r1, #0
...
.LnpgoWLD_TryAgainYesNo_Af_main_4:
	...
	ldr	r2, .LnpgoWLD_TryAgainYesNo_Af_main_10 + 4 @ 0xa5c
	add	r0, r1, r2
	mov	r2, #0x0
	strb	r2, [r0]
	ldr	r0, .LnpgoWLD_TryAgainYesNo_Af_main_10 + 8 @ 0xbc8
	add	r1, r1, r0
	ldrb	r0, [r1]
	add	r0, r0, #0x1
	strb	r0, [r1]
	...
	ldr	r0, .LnpgoWLD_TryAgainYesNo_Af_main_10 + 12 @ b_BG0VOFS
	strh	r2, [r0]
	ldr	r0, .LnpgoWLD_TryAgainYesNo_Af_main_10 + 16 @ b_BG0HOFS
	strh	r2, [r0]
	ldr	r0, .LnpgoWLD_TryAgainYesNo_Af_main_10 + 20 @ b_BG1VOFS
	strh	r2, [r0]
	ldr	r0, .LnpgoWLD_TryAgainYesNo_Af_main_10 + 24 @ b_BG1HOFS
	strh	r2, [r0]
	ldr	r0, .LnpgoWLD_TryAgainYesNo_Af_main_10 + 28 @ b_BG2VOFS
	strh	r2, [r0]
	ldr	r0, .LnpgoWLD_TryAgainYesNo_Af_main_10 + 32 @ b_BG2HOFS
	strh	r2, [r0]
	ldr	r0, .LnpgoWLD_TryAgainYesNo_Af_main_10 + 36 @ NisTitleInit + 1
