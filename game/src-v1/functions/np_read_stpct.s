...
.Lnp_read_stpct_1:
	...
	ldr	r2, .Lnp_read_stpct_9 + 8 @ 0xb94
	add	r1, r0, r2
	ldr	r2, [r1]
	ldr	r5, .Lnp_read_stpct_9 + 12 @ 0xb98
	add	r1, r0, r5
	ldr	r5, [r1]
	add	r6, r0, #0
	cmp	r2, #0
...
.Lnp_read_stpct_26:
	add	r4, r0, #0
.Lnp_read_stpct_24:
	ldr	r1, .Lnp_read_stpct_29 @ 0xa85
	add	r0, r6, r1
	ldrb	r0, [r0]
	cmp	r0, #0
...
.Lnp_read_stpct_48:
	add	r4, r0, #0
.Lnp_read_stpct_46:
	ldr	r1, .Lnp_read_stpct_51 @ 0xa85
	add	r0, r6, r1
	ldrb	r0, [r0]
	cmp	r0, #0
...
.Lnp_read_stpct_65:
	mov	r4, #0x0
.Lnp_read_stpct_67:
	ldr	r1, .Lnp_read_stpct_70 @ 0xa85
	add	r0, r6, r1
	ldrb	r0, [r0]
	cmp	r0, #0
