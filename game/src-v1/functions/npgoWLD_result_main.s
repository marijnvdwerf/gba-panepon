...
npgoWLD_result_main:
	...
	ldr	r0, .LnpgoWLD_result_main_3 + 4 @ 0xbc8
	add	r1, r1, r0
	ldrb	r0, [r1]
	add	r0, r0, #0x1
	strb	r0, [r1]
...
.LnpgoWLD_result_main_1:
	...
	ldr	r1, .LnpgoWLD_result_main_10 + 4 @ 0xbd4
	add	r2, r3, r1
	sub	r0, r0, #0x7
	str	r0, [r2]
	cmp	r0, #0
...
.LnpgoWLD_result_main_14:
	...
	ldr	r0, .LnpgoWLD_result_main_20 + 8 @ 0xbc8
	add	r1, r1, r0
	ldrb	r0, [r1]
	add	r0, r0, #0x1
	strb	r0, [r1]
.LnpgoWLD_result_main_17:
	...
	add	r1, r5, #2
	ldr	r2, .LnpgoWLD_result_main_20 + 16 @ Aob_Panel_TryAgain_04
	mov	r0, #0x7e
	bl	NisCtc_PutCtc
.LnpgoWLD_result_main_18:
	ldr	r3, .LnpgoWLD_result_main_20 + 20 @ 0xbd4
	add	r0, r6, r3
	ldr	r1, [r4]
	ldr	r0, [r0]
	cmp	r1, r0
	...
	mov	r1, #0x96
	sub	r1, r1, r5
	ldr	r2, .LnpgoWLD_result_main_20 + 24 @ Aob_Panel_TryAgain_05
	mov	r0, #0x7e
	bl	NisCtc_PutCtc
