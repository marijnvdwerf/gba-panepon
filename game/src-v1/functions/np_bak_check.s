...
.Lnp_bak_check_11:
	...
	strb	r7, [r4, #0xb]
	strh	r5, [r3]
	ldr	r3, .Lnp_bak_check_18 + 4 @ 0xb9c
	add	r0, r6, r3
	mov	r5, r9
	str	r5, [r0]
	ldr	r0, .Lnp_bak_check_18 + 8 @ NRam+0xba8
	str	r5, [r0]
	mov	r0, r9
	sub	r0, r0, #0x1
	lsl	r0, r0, #0x18
...
.Lnp_bak_check_25:
	...
	ldr	r5, .Lnp_bak_check_30 + 12 @ 0xb98
	add	r0, r3, r5
	str	r7, [r0]
	ldr	r1, .Lnp_bak_check_30 + 16 @ 0xba4
	add	r0, r3, r1
	str	r7, [r0]
	b	.Lnp_bak_check_33
.Lnp_bak_check_31:
...
.Lnp_bak_check_28:
	...
	ldr	r3, .Lnp_bak_check_34 + 8 @ 0xb98
	add	r0, r2, r3
	str	r1, [r0]
	ldr	r5, .Lnp_bak_check_34 + 12 @ 0xba4
	add	r0, r2, r5
	str	r1, [r0]
	b	.Lnp_bak_check_33
.Lnp_bak_check_35:
...
.Lnp_bak_check_32:
	...
	ldr	r2, .Lnp_bak_check_40 + 4 @ 0xb98
	add	r0, r1, r2
	ldr	r3, .Lnp_bak_check_40 + 8 @ 0xff9b
	str	r3, [r0]
	ldr	r5, .Lnp_bak_check_40 + 12 @ 0xba4
	add	r0, r1, r5
	str	r3, [r0]
.Lnp_bak_check_33:
	ldr	r1, .Lnp_bak_check_40 + 16 @ NRam+0xba8
	ldr	r0, [r1]
	cmp	r0, #0
