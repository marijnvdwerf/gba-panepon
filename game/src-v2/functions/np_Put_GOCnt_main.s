...
np_Put_GOCnt_main:
	...
	ldr	r2, .Lnp_Put_GOCnt_main_6 + 8 @ 0xa59
	add	r1, r0, r2
	ldrb	r1, [r1]
	add	r6, r0, #0
	cmp	r1, #0
	beq	.Lnp_Put_GOCnt_main_2	@cond_branch
	ldr	r1, .Lnp_Put_GOCnt_main_6 + 12 @ 0xa61
	add	r0, r6, r1
	ldrb	r0, [r0]
	cmp	r0, #0
...
.Lnp_Put_GOCnt_main_4:
	add	r4, r6, #0
	ldr	r0, .Lnp_Put_GOCnt_main_6 + 16 @ 0xa63
	add	r7, r4, r0
	ldr	r1, .Lnp_Put_GOCnt_main_6 + 12 @ 0xa61
	add	r5, r4, r1
	ldrb	r0, [r7]
	...
	add	r1, r2, #0
	sub	r1, r1, r0
	ldr	r2, .Lnp_Put_GOCnt_main_6 + 20 @ 0xa64
	add	r0, r4, r2
	strb	r1, [r0]
.Lnp_Put_GOCnt_main_5:
	ldr	r1, .Lnp_Put_GOCnt_main_6 + 20 @ 0xa64
	add	r0, r6, r1
	ldrb	r1, [r0]
	ldr	r2, .Lnp_Put_GOCnt_main_6 + 24 @ Aob_Panel_TryAgain_06+0x10
	mov	r0, #0x5c
	bl	NisCtc_PutCtc
	ldrb	r0, [r5]
	strb	r0, [r7]
...
.Lnp_Put_GOCnt_main_6:
	...
	.word	0xa63
	.word	0xa64
	.word	Aob_Panel_TryAgain_06+0x10
