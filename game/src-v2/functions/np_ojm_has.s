...
.Lnp_ojm_has_23:
	.word	0xac4
.Lnp_ojm_has_12:
	ldr	r1, .Lnp_ojm_has_28 @ 0xac5
	add	r0, r3, r1
	ldrb	r1, [r0]
	add	r1, r1, #0x1
	cmp	r1, #0x3
	blt	.Lnp_ojm_has_25	@cond_branch
	mov	r0, #0x5
	cmp	r0, r1
	bge	.Lnp_ojm_has_26	@cond_branch
.Lnp_ojm_has_25:
	mov	r1, #0x3
.Lnp_ojm_has_26:
	ldr	r4, .Lnp_ojm_has_28 @ 0xac5
	b	.Lnp_ojm_has_27
.Lnp_ojm_has_29:
	.align	2, 0
.Lnp_ojm_has_28:
	.word	0xac5
.Lnp_ojm_has_18:
	ldr	r1, .Lnp_ojm_has_33 @ 0xac6
	add	r0, r3, r1
	ldrb	r1, [r0]
	add	r1, r1, #0x1
	cmp	r1, #0x4
	blt	.Lnp_ojm_has_30	@cond_branch
	mov	r0, #0x5
	cmp	r0, r1
	bge	.Lnp_ojm_has_31	@cond_branch
.Lnp_ojm_has_30:
	mov	r1, #0x4
.Lnp_ojm_has_31:
	ldr	r4, .Lnp_ojm_has_33 @ 0xac6
.Lnp_ojm_has_27:
	add	r0, r3, r4
	strb	r1, [r0]
	ldrb	r0, [r0]
...
.Lnp_ojm_has_33:
	.word	0xac6
.Lnp_ojm_has_19:
	ldr	r0, .Lnp_ojm_has_35 @ NRam+0x17c
.Lnp_ojm_has_32:
	add	r1, r2, #0
	mov	r2, #0x0
	bl	np_ojm_put
