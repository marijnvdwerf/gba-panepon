...
np_tenmetu_spdlv:
	...
	ldr	r0, .Lnp_tenmetu_spdlv_8 + 4 @ 0xab8
	add	r4, r1, r0
	ldr	r0, [r4]
	add	r5, r1, #0
	cmp	r0, #0
	...
	ldrh	r3, [r4]
	ldr	r2, .Lnp_tenmetu_spdlv_8 + 8 @ 0xaba
	add	r0, r1, r2
	strh	r3, [r0]
	lsl	r0, r3, #0x10
	cmp	r0, #0
	...
	ldr	r2, .Lnp_tenmetu_spdlv_8 + 12 @ 0xab6
	add	r0, r1, r2
	ldrb	r1, [r0]
	neg	r0, r1
	orr	r0, r0, r1
...
.Lnp_tenmetu_spdlv_11:
	ldr	r1, .Lnp_tenmetu_spdlv_17 @ 0xabc
	add	r0, r5, r1
	ldrb	r1, [r0]
	add	r1, r1, #0x1
	cmp	r1, #0
...
.Lnp_tenmetu_spdlv_13:
	ldr	r2, .Lnp_tenmetu_spdlv_17 @ 0xabc
	add	r0, r5, r2
	strb	r1, [r0]
	lsl	r0, r1, #0x18
	lsr	r0, r0, #0x18
