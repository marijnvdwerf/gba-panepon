...
.Lnp_DemoKeyDat_Play_1:
	...
	ldr	r0, .Lnp_DemoKeyDat_Play_20 + 16 @ 0xbe4
	add	r7, r5, r0
	ldrb	r4, [r7]
	cmp	r4, #0
...
.Lnp_DemoKeyDat_Play_4:
	...
	mov	r0, #0x1
	strb	r0, [r7]
	ldr	r2, .Lnp_DemoKeyDat_Play_20 + 32 @ 0xbdc
	add	r0, r5, r2
	str	r1, [r0]
	mov	r3, #0xbe
	lsl	r3, r3, #0x4
...
.Lnp_DemoKeyDat_Play_3:
	...
	ldr	r1, .Lnp_DemoKeyDat_Play_20 + 16 @ 0xbe4
	add	r4, r0, r1
	ldrb	r1, [r4]
	mov	r8, r0
	cmp	r1, #0
...
.Lnp_DemoKeyDat_Play_6:
	...
	ldr	r0, .Lnp_DemoKeyDat_Play_20 + 36 @ NisTitleInit + 1
...
.Lnp_DemoKeyDat_Play_5:
	ldr	r0, .Lnp_DemoKeyDat_Play_20 + 32 @ 0xbdc
	add r0, r0, r8
	ldr	r0, [r0]
	cmp	r0, #0
...
.Lnp_DemoKeyDat_Play_9:
	...
	ldr	r0, .Lnp_DemoKeyDat_Play_20 + 40 @ 0xbe2
	add r0, r0, r8
	mov	ip, r0
	ldrh	r4, [r0]
	mov	r0, #0x1
