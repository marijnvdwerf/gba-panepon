...
np_csl_swap:
	...
	b	.Lnp_csl_swap_57
.Lnp_csl_swap_1:
	ldr	r0, .Lnp_csl_swap_25 + 4 @ KeyRead_Trg
	ldr	r2, .Lnp_csl_swap_25 + 8 @ 0xbc6
	add	r1, r3, r2
	ldrh	r2, [r0]
	ldrh	r0, [r1]
	and	r0, r0, r2
...
.Lnp_csl_swap_56:
	...
	ldr	r3, .Lnp_csl_swap_60 + 4 @ 0xa74
	add	r4, r2, r3
	ldrb	r0, [r4]
	cmp	r0, #0
...
.Lnp_csl_swap_58:
	...
	add	r0, r2, r3
	strb	r1, [r0]
	ldr	r1, .Lnp_csl_swap_62 + 4 @ 0xa78
	add	r0, r2, r1
	str	r5, [r0]
	mov	r0, #0x8
	bl	m4aSongNumStart
