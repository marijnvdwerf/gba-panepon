...
.Lnp_srwreq_score_6:
	...
	str	r1, [r3, #0x30]
.Lnp_srwreq_score_20:
	ldr	r0, .Lnp_srwreq_score_22 + 4 @ Asc_KAZ2_Size12_NML_Tbl
	ldr	r4, .Lnp_srwreq_score_22 + 8 @ CRAM_BGA_SCR_GameFrame+0x12e
	mov	r1, #0x0
	str	r1, [sp]
	mov	r5, #0x6
	str	r5, [sp, #0x4]
	...
	add	r3, r4, #0
	bl	PutBgBigDex
	ldr	r0, .Lnp_srwreq_score_22 + 12 @ Asc_KAZU_Size12_NML_Tbl
	add	r4, r4, #0xc0
	str	r6, [sp]
	str	r5, [sp, #0x4]
	ldr	r1, [r7]
...
.Lnp_srwreq_score_10:
	...
	str	r1, [r2, #0x34]
.Lnp_srwreq_score_24:
	ldr	r0, .Lnp_srwreq_score_25 + 4 @ Asc_KAZ2_Size12_NML_Tbl
	ldr	r4, .Lnp_srwreq_score_25 + 8 @ CRAM_BGA_SCR_GameFrame+0x12e
	mov	r1, #0x0
	str	r1, [sp]
	mov	r5, #0x6
	str	r5, [sp, #0x4]
	...
	add	r3, r4, #0
	bl	PutBgBigDex
	ldr	r0, .Lnp_srwreq_score_25 + 12 @ Asc_KAZU_Size12_NML_Tbl
	add	r4, r4, #0xc0
	str	r6, [sp]
	str	r5, [sp, #0x4]
	ldr	r1, [r7]
