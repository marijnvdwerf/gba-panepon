...
np_game_code_set:
	...
	ldr	r0, .Lnp_game_code_set_9 + 4 @ 0x8c8
	add	r2, r6, r0
	add	r4, r6, #0
.Lnp_game_code_set_3:
	add	r3, r4, #0
	...
	ldr	r7, .Lnp_game_code_set_9 + 8 @ 0x8ca
	add	r2, r0, r7
.Lnp_game_code_set_7:
	ldrh	r0, [r2]
	sub	r0, r0, #0x1
...
.Lnp_game_code_set_4:
	...
	ldr	r7, .Lnp_game_code_set_16 + 4 @ 0x8ca
	add	r2, r0, r7
...
.Lnp_game_code_set_2:
	lsl	r0, r1, #0x2
	add	r0, r0, r6
	ldr	r2, .Lnp_game_code_set_16 + 4 @ 0x8ca
	add	r1, r0, r2
	strh	r5, [r1]
	ldr	r7, .Lnp_game_code_set_16 + 8 @ 0x8c8
	add	r0, r0, r7
	mov	r1, #0x1
	strh	r1, [r0]
...
.Lnp_game_code_set_16:
	...
	.word	0x8c8
.Lnp_game_code_set_1:
	ldr	r0, .Lnp_game_code_set_19 @ 0x8c8
	add	r2, r4, r0
	ldrh	r1, [r2]
