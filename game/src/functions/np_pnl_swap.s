...
.Lnp_pnl_swap_1:
	...
	ldr	r5, .Lnp_pnl_swap_16 + 4 @ 0xaf4
	add	r0, r4, r5
	ldr	r2, [r0]
	ldrb	r0, [r2]
	lsl	r0, r0, #0x1
	...
	add	r0, r0, r3
	ldrh	r1, [r0]
	ldr	r2, .Lnp_pnl_swap_16 + 8 @ 0xb02
	add	r0, r4, r2
	strh	r1, [r0]
	ldr	r3, .Lnp_pnl_swap_16 + 12 @ 0xadb
	add	r0, r4, r3
	ldrb	r0, [r0]
	cmp	r0, #0x8
...
.Lnp_pnl_swap_12:
	ldr	r5, .Lnp_pnl_swap_16 + 16 @ 0xaf8
	add	r1, r4, r5
...
.Lnp_pnl_swap_22:
	...
	.word	nswp_0c_frame
.Lnp_pnl_swap_14:
	ldr	r3, .Lnp_pnl_swap_27 @ 0xaf8
	add	r1, r4, r3
	ldr	r0, .Lnp_pnl_swap_27 + 4 @ nswp_10_frame
.Lnp_pnl_swap_21:
	str	r0, [r1]
	ldr	r5, .Lnp_pnl_swap_27 + 8 @ 0xaf1
	add	r0, r4, r5
	ldrb	r1, [r0]
	lsl	r0, r1, #0x3
	sub	r0, r0, r1
	...
	add	r2, r0, #0
	add	r2, r2, #0x5c
	ldr	r3, .Lnp_pnl_swap_27 + 12 @ 0xafc
	add	r1, r4, r3
	strb	r2, [r1]
	add	r0, r0, #0x6a
	add	r5, r5, #0xc
	add	r1, r4, r5
	strb	r0, [r1]
	ldr	r1, .Lnp_pnl_swap_27 + 16 @ 0xaf2
	add	r0, r4, r1
	ldrb	r1, [r0]
	mov	r0, #0xd
	mul	r0, r0, r1
	add	r0, r0, #0x4
	ldr	r2, .Lnp_pnl_swap_27 + 20 @ 0xafe
	add	r1, r4, r2
	strb	r0, [r1]
	sub	r3, r3, #0x8
	add	r0, r4, r3
...
.Lnp_pnl_swap_24:
	...
	ldr	r0, .Lnp_pnl_swap_27 + 28 @ 0xaf4
	add	r5, r4, r0
	ldr	r0, [r5]
	bl	nswp_0sp
	ldr	r0, [r5]
...
.Lnp_pnl_swap_27:
	...
	.word	0xaf4
.Lnp_pnl_swap_25:
	ldr	r5, .Lnp_pnl_swap_29 @ 0xafc
	add	r1, r3, r5
	ldrb	r0, [r1]
	add	r0, r0, r2
	strb	r0, [r1]
	ldr	r0, .Lnp_pnl_swap_29 + 4 @ 0xafd
	add	r1, r3, r0
	ldrb	r0, [r1]
	sub	r0, r0, r2
	strb	r0, [r1]
