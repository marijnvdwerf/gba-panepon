...
.Lnp_bak_check_7:
	...
	ldr	r3, .Lnp_bak_check_14 + 16 @ 0xac8
	add	r2, r6, r3
...
.Lnp_bak_check_9:
	...
	ldr	r0, [r2]
	ldr	r1, .Lnp_bak_check_14 + 20 @ 0xff9b
	cmp	r0, r1
...
.Lnp_bak_check_11:
	...
	strb	r7, [r4, #0xb]
	strh	r5, [r3]
	ldr	r3, .Lnp_bak_check_18 + 4 @ 0xc1c
	add	r0, r6, r3
	mov	r5, r9
	str	r5, [r0]
	ldr	r0, .Lnp_bak_check_18 + 8 @ NRam+0xc28
	str	r5, [r0]
	mov	r0, r9
	sub	r0, r0, #0x1
	lsl	r0, r0, #0x18
...
.Lnp_bak_check_25:
	...
	ldr	r2, .Lnp_bak_check_30 + 8 @ 0xac8
	add	r0, r1, r2
	ldr	r1, [r0]
	cmp	r1, #0x1
	bgt	.Lnp_bak_check_28	@cond_branch
	ldr	r3, .Lnp_bak_check_30 + 4 @ NRam
	ldr	r5, .Lnp_bak_check_30 + 12 @ 0xc18
	add	r0, r3, r5
	str	r7, [r0]
	ldr	r1, .Lnp_bak_check_30 + 16 @ 0xc24
	add	r0, r3, r1
	str	r7, [r0]
	b	.Lnp_bak_check_33
.Lnp_bak_check_31:
...
.Lnp_bak_check_28:
	...
	ldr	r3, .Lnp_bak_check_34 + 8 @ 0xc18
	add	r0, r2, r3
	str	r1, [r0]
	ldr	r5, .Lnp_bak_check_34 + 12 @ 0xc24
	add	r0, r2, r5
	str	r1, [r0]
	b	.Lnp_bak_check_33
.Lnp_bak_check_35:
...
.Lnp_bak_check_32:
	...
	ldr	r2, .Lnp_bak_check_40 + 4 @ 0xc18
	add	r0, r1, r2
	ldr	r3, .Lnp_bak_check_40 + 8 @ 0xff9b
	str	r3, [r0]
	ldr	r5, .Lnp_bak_check_40 + 12 @ 0xc24
	add	r0, r1, r5
	str	r3, [r0]
.Lnp_bak_check_33:
	ldr	r1, .Lnp_bak_check_40 + 16 @ NRam+0xc28
	ldr	r0, [r1]
	cmp	r0, #0
...
.Lnp_bak_check_37:
	ldr	r1, .Lnp_bak_check_40 @ NRam
	ldr	r2, .Lnp_bak_check_40 + 24 @ 0x8c4
	add	r0, r1, r2
	strb	r7, [r0]
	ldr	r0, [sp]
	ldr	r1, [sp, #0x4]
