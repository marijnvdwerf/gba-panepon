...
.Lnp_rlup_add_1:
	...
	ldr	r2, .Lnp_rlup_add_10 + 12 @ 0xc44
	add	r1, r3, r2
	ldrh	r2, [r0]
	ldrh	r0, [r1]
	and	r0, r0, r2
	...
	ldr	r5, .Lnp_rlup_add_10 + 16 @ 0xb2e
	add	r1, r3, r5
	ldrb	r0, [r1]
	cmp	r0, #0
	...
	mov	r2, #0x1
	strb	r2, [r1]
	ldr	r0, .Lnp_rlup_add_10 + 20 @ 0xb2f
	add	r1, r3, r0
	ldrb	r0, [r1]
	cmp	r0, #0
	bne	.Lnp_rlup_add_6	@cond_branch
	strb	r2, [r1]
	ldr	r1, .Lnp_rlup_add_10 + 24 @ 0xb0c
	add	r2, r3, r1
	ldr	r0, [r2]
	add	r0, r0, #0x1
	str	r0, [r2]
	...
	str	r1, [r2]
.Lnp_rlup_add_6:
	ldr	r1, .Lnp_rlup_add_10 + 16 @ 0xb2e
	add	r0, r3, r1
	ldrb	r0, [r0]
	cmp	r0, #0
	bne	.Lnp_rlup_add_7	@cond_branch
	...
	cmp	r0, #0
	beq	.Lnp_rlup_add_15	@cond_branch
	ldr	r2, .Lnp_rlup_add_10 + 28 @ 0xb2a
	add	r0, r3, r2
	ldrh	r2, [r0]
	b	.Lnp_rlup_add_9
.Lnp_rlup_add_11:
...
.Lnp_rlup_add_7:
	...
	ldr	r2, .Lnp_rlup_add_18 + 4 @ 0xb39
	add	r0, r3, r2
	ldrb	r0, [r0]
	cmp	r0, #0
	bne	.Lnp_rlup_add_15	@cond_branch
.Lnp_rlup_add_12:
	mov	r2, #0x80
	lsl	r2, r2, #0x5
	ldr	r5, .Lnp_rlup_add_18 + 8 @ 0xb2c
	add	r1, r3, r5
	mov	r0, #0x0
	strh	r0, [r1]
.Lnp_rlup_add_9:
	ldr	r0, .Lnp_rlup_add_18 + 8 @ 0xb2c
	add	r1, r3, r0
	ldrh	r0, [r1]
	add	r0, r2, r0
	strh	r0, [r1]
...
.Lnp_rlup_add_16:
	...
	ldr	r1, .Lnp_rlup_add_18 + 8 @ 0xb2c
	add	r0, r0, r1
	ldrh	r2, [r0]
