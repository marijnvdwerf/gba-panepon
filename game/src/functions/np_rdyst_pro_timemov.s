...
.Lnp_rdyst_pro_timemov_30:
	ldr	r1, .Lnp_rdyst_pro_timemov_37 @ 0xb18
	add	r0, r3, r1
	strb	r2, [r0]
	ldr	r4, .Lnp_rdyst_pro_timemov_37 + 4 @ 0xb19
	add	r0, r3, r4
	strb	r2, [r0]
	ldr	r0, .Lnp_rdyst_pro_timemov_37 + 8 @ 0xb1a
	add	r1, r3, r0
	mov	r0, #0x2
	strb	r0, [r1]
	ldr	r1, .Lnp_rdyst_pro_timemov_37 + 12 @ 0xb1b
	add	r0, r3, r1
	strb	r2, [r0]
	b	.Lnp_rdyst_pro_timemov_36
...
.Lnp_rdyst_pro_timemov_28:
	ldr	r4, .Lnp_rdyst_pro_timemov_40 @ 0xb18
	add	r0, r3, r4
	mov	r1, #0x0
	strb	r1, [r0]
	add	r4, r4, #0x1
	...
	add	r0, r3, r4
	strb	r2, [r0]
	ldr	r2, .Lnp_rdyst_pro_timemov_40 + 4 @ 0xb1b
	add	r0, r3, r2
...
.Lnp_rdyst_pro_timemov_34:
	ldr	r4, .Lnp_rdyst_pro_timemov_43 @ 0xb18
	add	r0, r3, r4
	mov	r1, #0x0
	strb	r1, [r0]
	ldr	r0, .Lnp_rdyst_pro_timemov_43 + 4 @ 0xb19
	add	r2, r3, r0
	mov	r0, #0x14
	strb	r0, [r2]
	ldr	r2, .Lnp_rdyst_pro_timemov_43 + 8 @ 0xb1a
	add	r0, r3, r2
	strb	r1, [r0]
	add	r4, r4, #0x3
	add	r0, r3, r4
